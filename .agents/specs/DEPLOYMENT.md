...
4. O Docker da VPS é autenticado no GHCR com o token efêmero do workflow.
5. Se a stack já existe, somente o serviço `web` é atualizado pelo Compose.
6. No primeiro deploy, a imagem web é publicada; a execução do pipeline da API
